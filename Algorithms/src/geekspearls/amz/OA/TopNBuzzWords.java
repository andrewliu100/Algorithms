 ...
 * Difference: No sort based on number of times in quotes. Multiple times in one quotes considered to be one mention.
 *
 ...
 * If toys are mentioned an equal number of times in quotes, then we need to sort based on the occurrences of each toy in different quotes,
